        ...
        <div className="row text-center">
          <div className="col-md-4">
            ...
            <p>
              ...
              We believe that individualism has lived: place for communities of
              minds
            </p>
          </div>
          <div className="col-md-4">
                ...
                <div className="col-md-6 d-flex mb-4">
                  ...
                  <div>
                    ...
                    <h5 className="text-justify">
                      Every morning you get together with the community to work.
                      Wherever you want, online, in person.
                    </h5>
                  </div>
                </div>
                <div className="col-md-6 d-flex mb-4">
                  ...
                  <div>
                    <h2>.. No teachers</h2>
                    <h5 className="text-justify">
                      Online resources, projects, united people to support you,
                      a unique educational platform and a community to help you.
                    </h5>
                  </div>
                </div>
                <div className="col-md-6 d-flex mb-4">
